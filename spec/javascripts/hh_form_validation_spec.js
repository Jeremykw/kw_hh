describe("Health History Validate Form Zero", function() {
  ...
  it("should return false if hh_form_first_name is blank", function() {
    ...
    expect(currentPageForm.isValid.valid).toEqual(false);
    expect(currentPageForm.isValid.hh_form_first_name).toEqual("First Name Must Be Present");
  });
  ...
  it("should return false if hh_form_last_name is blank", function() {
    ...
    currentPageForm = new hhForm(initForm, action);
    expect(currentPageForm.isValid.valid).toEqual(false);
    expect(currentPageForm.isValid.hh_form_last_name).toEqual("Last Name Must Be Present");
  ...
  it("should return false if hh_form_email is blank", function() {
    ...
    currentPageForm = new hhForm(initForm, action);
    expect(currentPageForm.isValid.valid).toEqual(false);
    expect(currentPageForm.isValid.hh_form_email).toEqual("Email Must Be Present");
  ...
  it("should return false if hh_form_phone is blank", function() {
    ...
    currentPageForm = new hhForm(initForm, action);
    expect(currentPageForm.isValid.valid).toEqual(false);
    expect(currentPageForm.isValid.hh_form_phone).toEqual("Phone Must Be Present");
